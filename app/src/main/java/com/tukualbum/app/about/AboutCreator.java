...
public class AboutCreator extends RelativeLayout implements Themed {
    ...
    @BindView(com.tukualbum.app.R.id.developer_header_image) ImageView headerImage;
    @BindView(com.tukualbum.app.R.id.developer_profile_image) CircleImageView profileImage;
    @BindView(com.tukualbum.app.R.id.developer_name) TextView devName;
    @BindView(com.tukualbum.app.R.id.developer_role) TextView devRole;
    @BindView(com.tukualbum.app.R.id.developer_description) TextView devDescription;
    @BindView(com.tukualbum.app.R.id.developer_contacts) LinearLayout devContacts;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        setupView(context);
        LayoutInflater.from(context).inflate(com.tukualbum.app.R.layout.view_about_creator, this, true);
    ...
    public void setupListeners(ContactListener listener, String mail, ArrayList<Contact> contacts) {
        ...
        if (mail != null) {
            ...
            email.setText(getContext().getString(com.tukualbum.app.R.string.send_email));
            email.bold();
    ...
    private void setupView(@NonNull Context context) {
        ...
        int verticalPadding = getResources().getDimensionPixelOffset(com.tukualbum.app.R.dimen.developer_small_Spacing);
        setPadding(0, 0, 0, verticalPadding);
    }

    private void setupData(@NonNull Context context, @NonNull AttributeSet attributeSet) {
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, com.tukualbum.app.R.styleable.AboutCreator);
        Drawable headerImage = typedArray.getDrawable(com.tukualbum.app.R.styleable.AboutCreator_headerImage);
        Drawable profileImage = typedArray.getDrawable(com.tukualbum.app.R.styleable.AboutCreator_displayImage);
        String displayName = typedArray.getString(com.tukualbum.app.R.styleable.AboutCreator_name);
        String roleText = typedArray.getString(com.tukualbum.app.R.styleable.AboutCreator_role);
        String descriptionText = typedArray.getString(com.tukualbum.app.R.styleable.AboutCreator_description);
        typedArray.recycle();
