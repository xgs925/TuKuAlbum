...
public class ContributorViewHolder extends ThemedViewHolder {
    ...
    @BindView(com.tukualbum.app.R.id.contributor_profile_image) CircleImageView profileImage;
    @BindView(com.tukualbum.app.R.id.contributor_name) TextView contribName;
    @BindView(com.tukualbum.app.R.id.contributor_description) TextView contribDescription;
    @BindView(com.tukualbum.app.R.id.contributor_contacts) LinearLayout contribContacts;
    ...
    public void load(Contributor contributor, ContactListener listener) {
        ...
        if (contributor.getEmail() != null) {
            ...
            email.setText(itemView.getContext().getString(com.tukualbum.app.R.string.send_email));
            email.bold();
