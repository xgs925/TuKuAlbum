...
public class DeleteAlbumsDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(com.tukualbum.app.R.layout.dialog_delete_album_progress, null, false);

        RecyclerView rv = view.findViewById(com.tukualbum.app.R.id.rv_folders);
        adapter = new FolderAdapter(getContext(), albums);
        rv.setLayoutManager(new LinearLayoutManager(getContext()));
        rv.setAdapter(adapter);

        dialogTitle = view.findViewById(com.tukualbum.app.R.id.text_dialog_title);

        fileName = view.findViewById(com.tukualbum.app.R.id.file_name);
        progress = view.findViewById(com.tukualbum.app.R.id.progress_bar);

        ((CardView) view.findViewById(com.tukualbum.app.R.id.message_card)).setCardBackgroundColor(t.getCardBackgroundColor());
        ...
        builder.setNegativeButton(getString(com.tukualbum.app.R.string.cancel).toUpperCase(), (dialogInterface, i) -> {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        public static AlertDialog getTextDialog(ThemedActivity activity, @StringRes int title, @StringRes int Message){
            ...
            TextView folderName = (TextView) dialogLayout.findViewById(R.id.text_dialog_message);
