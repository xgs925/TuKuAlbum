...
import com.tukualbum.app.LookForMediaJob;
import com.tukualbum.app.activities.base.SharedMediaActivity;
import com.tukualbum.app.util.PermissionUtils;
...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "com.tukualbum.app.OPEN_ALBUM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.tukualbum.app.R.layout.activity_splash);
    ...
    private void start() {
        Intent intent = new Intent(SplashScreen.this, com.tukualbum.app.activity.MainActivity.class);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.tukualbum.app.R.color.md_black_1000), 70));
        }
    }
        ...
        switch (requestCode) {
            case EXTERNAL_STORAGE_PERMISSIONS:
                ...
                if (gotPermission) {
                    ...
                    Toast.makeText(SplashScreen.this, getString(com.tukualbum.app.R.string.storage_permission_denied), Toast.LENGTH_LONG).show();
                    finish();
                }
                break;
            default:
    ...
    public void updateUiElements() {
        ...
        ((ProgressBar) findViewById(com.tukualbum.app.R.id.progress_splash)).getIndeterminateDrawable().setColorFilter(getPrimaryColor(), PorterDuff.Mode.SRC_ATOP);
        findViewById(com.tukualbum.app.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
