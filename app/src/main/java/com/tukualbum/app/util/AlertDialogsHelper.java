...
import com.tukualbum.app.data.metadata.MediaDetailsMap;
import com.tukualbum.app.data.metadata.MetadataHelper;
...
import static com.tukualbum.app.util.ServerConstants.LEAFPIC_CHANGELOG;
...
public class AlertDialogsHelper {
    ...
    public static  AlertDialog getInsertTextDialog(ThemedActivity activity, EditText editText, @StringRes int title) {
        ...
        View dialogLayout = activity.getLayoutInflater().inflate(com.tukualbum.app.R.layout.dialog_insert_text, null);
        TextView textViewTitle = dialogLayout.findViewById(com.tukualbum.app.R.id.rename_title);

        ((CardView) dialogLayout.findViewById(com.tukualbum.app.R.id.dialog_chose_provider_title)).setCardBackgroundColor(activity.getCardBackgroundColor());
        ...
        ((RelativeLayout) dialogLayout.findViewById(com.tukualbum.app.R.id.container_edit_text)).addView(editText);
    ...
    public static AlertDialog getTextDialog(ThemedActivity activity, @StringRes int title, @StringRes int Message){
        ...
        View dialogLayout = activity.getLayoutInflater().inflate(com.tukualbum.app.R.layout.dialog_text, null);

        TextView dialogTitle = dialogLayout.findViewById(com.tukualbum.app.R.id.text_dialog_title);
        TextView dialogMessage = dialogLayout.findViewById(com.tukualbum.app.R.id.text_dialog_message);

        ((CardView) dialogLayout.findViewById(com.tukualbum.app.R.id.message_card)).setCardBackgroundColor(activity.getCardBackgroundColor());
    ...
    public static AlertDialog getProgressDialogWithErrors(ThemedActivity activity, @StringRes int title, ProgressAdapter adapter, int max) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity, activity.getDialogStyle());
        View dialogLayout = activity.getLayoutInflater().inflate(com.tukualbum.app.R.layout.dialog_list_progress, null);
        final int[] progress = {0};
        TextView dialogTitle = dialogLayout.findViewById(com.tukualbum.app.R.id.text_dialog_title);
        TextView progressMessage = dialogLayout.findViewById(com.tukualbum.app.R.id.name_folder);
        ((ProgressBar) dialogLayout.findViewById(com.tukualbum.app.R.id.progress_dialog_loading)).getIndeterminateDrawable()
        ...
        RecyclerView rv = dialogLayout.findViewById(com.tukualbum.app.R.id.rv_progress);
    ...
    public static AlertDialog getProgressDialog(final ThemedActivity activity,  String title, String message){
        ...
        View dialogLayout = activity.getLayoutInflater().inflate(com.tukualbum.app.R.layout.dialog_progress, null);
        TextView dialogTitle = dialogLayout.findViewById(com.tukualbum.app.R.id.progress_dialog_title);
        TextView dialogMessage = dialogLayout.findViewById(com.tukualbum.app.R.id.progress_dialog_text);

        dialogTitle.setBackgroundColor(activity.getPrimaryColor());
        ((CardView) dialogLayout.findViewById(com.tukualbum.app.R.id.progress_dialog_card)).setCardBackgroundColor(activity.getCardBackgroundColor());
        ((ProgressBar) dialogLayout.findViewById(com.tukualbum.app.R.id.progress_dialog_loading)).getIndeterminateDrawable().setColorFilter(activity.getPrimaryColor(), android.graphics
    ...
    public static AlertDialog getDetailsDialog(final ThemedActivity activity, final Media f) {
        ...
        final View dialogLayout = activity.getLayoutInflater().inflate(com.tukualbum.app.R.layout.dialog_media_detail, null);
        ImageView imgMap = dialogLayout.findViewById(com.tukualbum.app.R.id.photo_map);
        dialogLayout.findViewById(com.tukualbum.app.R.id.details_title).setBackgroundColor(activity.getPrimaryColor());
        ((CardView) dialogLayout.findViewById(com.tukualbum.app.R.id.photo_details_card)).setCardBackgroundColor(activity.getCardBackgroundColor());

        final GeoLocation location;
        if ((location = f.getGeoLocation()) != null) {

            StaticMapProvider staticMapProvider = StaticMapProvider.fromValue(
                    Hawk.get(activity.getString(com.tukualbum.app.R.string.preference_map_provider), StaticMapProvider.GOOGLE_MAPS.getValue()));
            ...
            imgMap.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    try {
                        ...
                        Toast.makeText(activity, com.tukualbum.app.R.string.no_app_to_perform, Toast.LENGTH_SHORT).show();
                    }
            ...
            dialogLayout.findViewById(com.tukualbum.app.R.id.details_title).setVisibility(View.GONE);

        } else imgMap.setVisibility(View.GONE);

        final TextView showMoreText = dialogLayout.findViewById(com.tukualbum.app.R.id.details_showmore);
    ...
    private static void loadDetails(View dialogLayout, ThemedActivity activity, MediaDetailsMap<String, String> metadata) {
        LinearLayout detailsTable = dialogLayout.findViewById(com.tukualbum.app.R.id.ll_list_details);
    ...
    public static AlertDialog showChangelogDialog(final ThemedActivity activity) {
        ...
        View dialogLayout = activity.getLayoutInflater().inflate(com.tukualbum.app.R.layout.dialog_changelog, null);

        TextView dialogTitle = dialogLayout.findViewById(com.tukualbum.app.R.id.dialog_changelog_title);
        TextView dialogMessage = dialogLayout.findViewById(com.tukualbum.app.R.id.dialog_changelog_text);
        CardView cvBackground = dialogLayout.findViewById(com.tukualbum.app.R.id.dialog_changelog_card);
        ScrollView scrChangelog = dialogLayout.findViewById(com.tukualbum.app.R.id.changelog_scrollview);
        ...
        dialogTitle.setText(activity.getString(com.tukualbum.app.R.string.changelog));
        ...
        changelogDialogBuilder.setPositiveButton(activity.getString(com.tukualbum.app.R.string.ok_action).toUpperCase(), null);
        changelogDialogBuilder.setNeutralButton(activity.getString(com.tukualbum.app.R.string.show_full).toUpperCase(), new DialogInterface.OnClickListener() {
            @Override
