package com.tukualbum.app.views.videoplayer;
...
public final class CustomExoPlayerView extends FrameLayout {
    ...
    public CustomExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(com.tukualbum.app.R.layout.exo_player, this);
        componentListener = new ComponentListener();
        layout = findViewById(com.tukualbum.app.R.id.video_frame);
        layout.setResizeMode(resizeMode);
        shutterView = findViewById(com.tukualbum.app.R.id.shutter);
        subtitleLayout = findViewById(com.tukualbum.app.R.id.subtitles);
        subtitleLayout.setUserDefaultStyle();
        subtitleLayout.setUserDefaultTextSize();

        controller = findViewById(com.tukualbum.app.R.id.control);
        controller.hide();
