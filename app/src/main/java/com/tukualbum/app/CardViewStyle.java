...
public enum CardViewStyle {
    MATERIAL(0, com.tukualbum.app.R.layout.card_album_material),
    FLAT(1, com.tukualbum.app.R.layout.card_album_flat),
    COMPACT(2, com.tukualbum.app.R.layout.card_album_compact);
