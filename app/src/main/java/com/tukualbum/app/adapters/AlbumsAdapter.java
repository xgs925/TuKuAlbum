...
import com.tukualbum.app.CardViewStyle;
import com.tukualbum.app.data.Album;
import com.tukualbum.app.data.AlbumsHelper;
import com.tukualbum.app.data.sort.AlbumsComparators;
...
public class AlbumsAdapter extends ThemedAdapter<AlbumsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (cardViewStyle) {
            default:
            case MATERIAL: v = LayoutInflater.from(parent.getContext()).inflate(com.tukualbum.app.R.layout.card_album_material, parent, false); break;
            case FLAT: v = LayoutInflater.from(parent.getContext()).inflate(com.tukualbum.app.R.layout.card_album_flat, parent, false); break;
            case COMPACT: v = LayoutInflater.from(parent.getContext()).inflate(com.tukualbum.app.R.layout.card_album_compact, parent, false); break;
        }
    ...
    public void onBindViewHolder(final AlbumsAdapter.ViewHolder holder, int position) {
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(com.tukualbum.app.R.drawable.ic_error)
        ...
        int textColor = getThemeHelper().getColor(getThemeHelper().getBaseTheme().equals(Theme.LIGHT) ? com.tukualbum.app.R.color.md_album_color_2 : com.tukualbum.app.R.color.md_album_color);

        if (a.isSelected())
            textColor = getThemeHelper().getColor(com.tukualbum.app.R.color.md_album_color);
    ...
    static class ViewHolder extends ThemedViewHolder {
        ...
        @BindView(com.tukualbum.app.R.id.album_card) CardView card;
        @BindView(com.tukualbum.app.R.id.album_preview) ImageView picture;
        @BindView(com.tukualbum.app.R.id.selected_icon)
        ThemedIcon selectedIcon;
        @BindView(com.tukualbum.app.R.id.ll_album_info) View footer;
        @BindView(com.tukualbum.app.R.id.ll_media_count) View llCount;
        @BindView(com.tukualbum.app.R.id.album_name) TextView name;
        @BindView(com.tukualbum.app.R.id.album_media_count) TextView nMedia;
        @BindView(com.tukualbum.app.R.id.album_media_label) TextView mediaLabel;
        @BindView(com.tukualbum.app.R.id.album_path) TextView path;
