...
import com.tukualbum.app.views.SquareRelativeLayout;
...
public class MediaAdapter extends ThemedAdapter<MediaAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(com.tukualbum.app.R.layout.card_photo, parent, false));
    }
...
//        });
    ...
    static class ViewHolder extends ThemedViewHolder {
        @BindView(com.tukualbum.app.R.id.photo_preview)
        ImageView imageView;
        @BindView(com.tukualbum.app.R.id.photo_path)
        TextView path;
        @BindView(com.tukualbum.app.R.id.gif_icon)
        ThemedIcon gifIcon;
        @BindView(com.tukualbum.app.R.id.icon)
        ThemedIcon icon;
        @BindView(com.tukualbum.app.R.id.media_card_layout)
